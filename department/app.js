...
const person1 = new Person ('Andrii', 'Ihnatiuk', 30)
const person2 = new Cars ('Tesla',2019)
const owner1 = new Garage('Andrii','Tesla, Cadilac')
const person3 = new Person ('Boris', 'johnson', 58)
const person4 = new Cars ('Toyota',2020)
const owner2 = new Garage('Andrii','Tesla, BMW, Audi ')
